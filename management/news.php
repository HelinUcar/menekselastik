...
<head>
    <title>Kampanya Listesi | MENEKŞE LASTİK YÖNETİM PANELİ</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">Kampanya Listesi</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Kampanyalar</a></li>
                                    <li class="breadcrumb-item active">Kampanya Listesi</li>
                                </ol>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Kampanya Listesi</h4>
                                <p class="card-title-desc">Buradan kampanyaları görebilir ve düzenleyebilirsiniz.</p>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#new-list').DataTable({
            ...
            "ajax": {
                "url": "engine/blog.php?action=get_blogs", // If same source is used
                "dataSrc": ""
            },
            "columns": [{
                    "data": "id"
                ...
                },
                {
                    "data": "id",
                    "render": function(data, type, row, meta) {
                        return '<a href="news-edit.php?id=' + data + '" class="btn btn-primary btn-sm">Düzenle</a> <button data-id="' + data + '" class="btn btn-danger btn-sm delete-blog">Sil</button>';
                    }
                }
            ]
        });
        ...
        $('#new-list_wrapper .row .col-md-6:eq(0)').append('<a href="news-add.php" class="btn btn-primary btn-sm">Yeni Kampanya Ekle</a>');
...
<script>
    ...
    $(document).on('click', '.delete-blog', function() {
        var id = $(this).data('id');
        $.ajax({
            url: 'engine/blog.php?action=delete_blog',
            type: 'POST',
            data: {
                id: id
            },
            success: function(response) {
                if (response.status == 'success') {
                    ...
                    showError('Kampanya silinirken bir hata oluştu.');
                }
            }
        });
    });
    ...
    $(document).on('change', '.status-toggle', function() {
        ...
        $.ajax({
            url: 'engine/blog.php?action=change_status',
            type: 'POST',
            data: {
                id: id,
                status: status

!function (a) { 
    ...
    a.sessionTimeout = function (b) { 
        ...
        function f(b, c) { 
            ...
            i.countdownBar && "dialog" === b ? j.percentLeft = Math.floor(j.timeLeft / ((i.redirAfter - i.warnAfter) / 1e3) * 100) : 
        ...
        var g, h = { 
            ...
            message: "Oturumunuz sona ermek üzere. Lütfen devam edin veya çıkış yapın.", 
            ...
            onWarn: !1, 
            onRedir: !1, 
            countdownMessage: "Oturum sona eriyor, {timer} saniye içinde çıkış yapılacak.", 
            countdownBar: !1, 
            countdownSmart: !1 
        }, 
        ...
        if (b && (i = a.extend(h, b)), 
        i.warnAfter >= i.redirAfter) return console.error('Bootstrap-session-timeout plugin is miss-configured. Option "redirAfter" must be equal or greater than "warnAfter".'), !1; 
        ...
        if ("function" != typeof i.onWarn) { 
            ...
            a("#session-timeout-dialog-logout").on("click", function () { window.location = i.logoutUrl }), 
        ...
        if (!i.ignoreUserActivity) { 
            ...
            a(document).on("keyup mouseup mousemove touchend touchmove", function (b) { 
                ...
                d(), 
                a("#session-timeout-dialog").length > 0 && a("#session-timeout-dialog").data("bs.modal") && a("#session-timeout-dialog").data("bs.modal").isShown && (a("#session-timeout-dialog").modal("hide"), a("body").removeClass("modal-open"), a("div.modal-backdrop").remove()) 
            }) 
        }
